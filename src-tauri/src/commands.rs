...
#[tauri::command]
pub fn get_antigravity_session_monitor_snapshot(
    monitor: tauri::State<'_, crate::session_monitor::ServiceHandle>,
) -> MonitorSnapshot {
    monitor.snapshot(AgentKind::Antigravity)
}

#[tauri::command]
pub fn delete_antigravity_session_monitor_session(
    monitor: tauri::State<'_, crate::session_monitor::ServiceHandle>,
    session_id: String,
) -> Result<(), CommandError> {
    monitor
        .remove_session(AgentKind::Antigravity, &session_id)
        .map_err(CommandError::General)
}

#[tauri::command]
pub fn get_antigravity_hook_status() -> Result<crate::session_monitor::HookStatus, CommandError> {
    crate::session_monitor::get_hook_status(AgentKind::Antigravity).map_err(CommandError::General)
}
...
#[tauri::command]
pub fn apply_antigravity_hook_change(
    action: String,
    expected_before_hash: String,
) -> Result<crate::session_monitor::HookStatus, CommandError> {
    crate::session_monitor::apply_hook_change(
